...
public class ListUniversitasAdapter extends RecyclerView.Adapter<ListUniversitasAdapter.CategoryViewHolder> {
    ...
    ListUniversitasAdapter(Context context){
        this.context = context;
    }
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder categoryViewHolder, int position) {
        categoryViewHolder.tvName.setText(getListUniversitas().get(position).getName());
        categoryViewHolder.tvRemarks.setText(getListUniversitas().get(position).getRemarks());
